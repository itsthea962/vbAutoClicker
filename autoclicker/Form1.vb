...
Public Class Form1
    ...
    Private Sub startBtn_Click(sender As Object, e As EventArgs) Handles startBtn.Click
        ...
        If intervalTimer.Enabled = True Then
            ...
            Dim hexColorRed As String = "#FF3244"
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            If My.Settings.selectedMode = "left" Then

                leftClick.Checked = True

            ElseIf My.Settings.selectedMode = "right" Then

                rightClick.Checked = True

            ElseIf My.Settings.selectedMode = "middle" Then

                middleClick.Checked = True

            ElseIf My.Settings.selectedMode = "up" Then

                scrollUp.Checked = True

            ElseIf My.Settings.selectedMode = "down" Then

                scrollDown.Checked = True

            ElseIf My.Settings.selectedMode = "leftright" Then

                leftRightClick.Checked = True
    ...
    Private Sub intervalTimer_Tick(sender As Object, e As EventArgs) Handles intervalTimer.Tick
        ...
        ElseIf middleClick.Checked = True Then

            Windows.Forms.Cursor.Position = New System.Drawing.Point(Windows.Forms.Cursor.Position)
            mouse_event(&H20, 0, 0, 0, 1)
            mouse_event(&H40, 0, 0, 0, 1)

        ElseIf leftRightClick.Checked = True Then
    ...
    Private Sub rightClick_CheckedChanged(sender As Object, e As EventArgs) Handles rightClick.CheckedChanged
        ...
        If rightClick.Checked = True Then
            ...
            My.Settings.selectedMode = "right"
    ...
    Private Sub middleClick_CheckedChanged(sender As Object, e As EventArgs) Handles middleClick.CheckedChanged

        If middleClick.Checked = True Then
            ...
            My.Settings.selectedMode = "middle"

        End If

    End Sub

    Private Sub leftRightClick_CheckedChanged(sender As Object, e As EventArgs) Handles leftRightClick.CheckedChanged

        If leftRightClick.Checked = True Then
            ...
            My.Settings.selectedMode = "leftright"
